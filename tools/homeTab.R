...
tabPanel(title = "Home", icon = icon("home"),
         ...
         div(id = "home",
             ...
             p(class = "outer",'DeconvoluteME: Deconvolute gene expression profiles from heterogeneous tissue samples into cell-type-specific subprofiles (Bowman et al. unpublished)'),
