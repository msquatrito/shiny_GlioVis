...
1. Select a dataset.
2. Enter a gene name.
3. Choose one of the histological group, default setting will show all the samples. For GBM datasets it's possible to exlcude G-CIMP and recurrent samples (when available). Morevoer, it's also possible to select a specific subtype.   
4. Select cutoff:       
