...
**Plot options:**   
* Remove/add a group of samples: For a specific plot the user can select which group to show. Only recomended for visualization, removing group of samples could profoundly affect the statistical analysis.   
...
* Color stripchart: It allows to color the points of the stripchart, using a different plot type catagory. E.g. The user can plot the Copy numbers and can color for the Subtype.   
* Change points appearance: It' is possible to change the size and the transparency of the points of the stripchart. Useful when generating small plots with a lot of points.  
