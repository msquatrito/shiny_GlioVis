...
tabPanel(title = "Home", icon = icon("home"),
         ...
         div(id = "home",
             ...
             p(class = "outer", strong("Of course!"), 'If you do so, please include references for the dataset(s) you used and cite: "GlioVis data portal for visualization and analysis of brain tumor expression datasets"', a("(Bowman R. et al., Neuro-Oncology 2016).", 
               href="http://neuro-oncology.oxfordjournals.org/cgi/content/full/now247?ijkey=IVd3fCU1KYzgZiU&keytype=ref", target="_blank")),
