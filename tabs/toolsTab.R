                       ...
                       sidebarPanel(
                         ...
                         wellPanel(
                           ...
                           conditionalPanel(
                             ...
                             div(class="row",
                                 div(class="col-xs-9",
                                     selectInput(inputId = "geneListDec", label = strong("Select genelist:"), 
                                                 choices = c("Charoentong et al. 2017", "Newman et al. 2015", "Bindea et al. 2013", "Engler et al. 2012","MSigDB gene sets"))
                                 ),
                                 div(class="col-xs-2",
                                     br(), p(" "),
                             ...
                             div(class="row",
                                 div(class="col-xs-6",
                                     numericInput(inputId = "min.sz", label = strong("Min. gene set size:"),value = 5, min = 5, max = 100, step = 5)
                                 ),
                                 div(class="col-xs-6",
                                     numericInput(inputId = "max.sz", label = strong("Max. gene set size:"),value = 300, min = 100,max = 2000, step = 100)
                                 )
                             ),
                             p(" ")
                           ),
